...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						...
						<a href="{{URL::to('/trang-chu')}}"><img src="{{('public/fontend/images/home/logo.png')}}" alt="" /></a>
						</div>
					...
					<div class="col-sm-5">
						<form action="{{URL::to('/tim-kiem')}}" method="post">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" style="margin-top:0; color:#333" name="search_items" class="btn btn-primary btn-sm" value="Tìm kiếm">
							</div>
						</form>
					</div>
				</div>
				...
				<div class="col-sm-12">
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<!-- <div class="carousel-inner">
							...
							<div class="item">
							<div class="col-sm-12">
									<img src="{{('public/image/baner3.jpg')}}" class="girl img-responsive" alt="" />
	...
	nonce="XeIugyXH"></script>
	<script type="text/javascript">
		$(document).ready(function(){
			$('.send_order').click(function(){
					swal({
					title: "Xác nhận đơn hàng",
					text: "Đơn hàng sẽ không hoàn trả khi đặt",
					type: "warning",
					...
					function(isConfirm) {
						if (isConfirm) {
							...
							$.ajax({
								...
								success:function(){	
											swal("Đơn hàng", "Đơn hàng của bạn dã đặt thành công", "success");	
								}
							});
							...
							swal("Đơn hàng", "Đơn hàng chưa đặt", "error");
						}
						});
		});
	});
